...
```bash
git remote add upstream https://github.com/LiuXiYing/JavaProgrammingPractice
```
...
upstream  https://github.com/LiuXiYing/JavaProgrammingPractice (fetch)
upstream  https://github.com/LiuXiYing/JavaProgrammingPractice (push)
```
